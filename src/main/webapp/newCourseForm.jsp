        ...
        <div class="col-md-6 mx-auto">
            ...
            <form action="CreateCourse" method="post">
                <div class="mb-3">
                    ...
                    <input class="form-control" name="courseCode" type="text" id="courseCode" required="required"/>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control" name="instructorId" type="text" id="instructorId"/>
                </div>
                <div class="mb-3">
                    <label for="semester">Semester</label>
                    <input class="form-control" name="semester" type="text" id="semester" required="required"/>
                </div>
                <div class="mb-3">
                    <label for="assessmentId">Assessment ID (Set to 0 if unknown)</label>
                    <input class="form-control" name="assessmentId" type="text" id="assessmentId"/>
                </div>
