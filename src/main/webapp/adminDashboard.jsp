    ...
    <div class="row mb-5">
        <div class="col-md-6 mx-auto">
            ...
            <table class="table table-responsive">
                ...
                <tr>
                    <th scope="row"><c:out value="${course.courseCode}"/></th>
                    <td><c:out value="${course.name}"/></td>
                    <td><c:out value="${course.semester}"/></td>
                    <td>150</td>
                    <td><c:out value="${course.instructorId}"/></td>
                    <td>
                        <a class="btn btn-sm btn-primary" href="edit?id=<c:out value='${course.id}'/>">Edit</a>
                        <a class="btn btn-sm btn-primary" href="delete?id=<c:out value='${course.id}'/>">Delete</a>
                    </td>
                </tr>
                </c:forEach>
                <tr>
