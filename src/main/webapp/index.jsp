    ...
    <div class="row">
        <div class="col-md-6 mx-auto mb-5">
            <div class="alert alert-info d-flex align-items-center" role="alert">
                ...
                <span><span class="fw-bold">Admins</span> - Manage courses and instructors</span>
            </div>
            <div class="alert alert-info d-flex align-items-center" role="alert">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                     class="bi bi-check-circle-fill flex-shrink-0 me-2" viewBox="0 0 16 16">
                ...
                <span><span class="fw-bold">Instructors</span> - Manage your courses, assessment criteria and student assessments</span>
            </div>
            <div class="alert alert-info d-flex align-items-center" role="alert">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                     class="bi bi-check-circle-fill flex-shrink-0 me-2" viewBox="0 0 16 16">
                ...
                <span><span class="fw-bold">Students</span> - Manage your courses and check your grades</span>
            </div>
        </div>
